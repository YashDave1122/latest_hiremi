...
class _JobDescriptionState extends State<JobDescription> {
      ...
      if (response.statusCode == 200) {
        ...
        for (int index = 0; index < dataList.length; index++) {
          ...
          if (index == widget.jobIndex) {
            final String jobcoderequired=data['job_code_required'];
            final dynamic jobCodeValue = data['job_code'];
  ...
  Future<List<int>> fetchJobCodes() async {
    final url = Uri.parse('${ApiUrls.baseurl}api/fresherjob/');
    ...
    if (response.statusCode == 200) {
      ...
      final List<int> jobCodes = jobList
          .map<int>((job) => (job['job_code'] != null) ? job['job_code'] as int : 0)
          .toList();
                  ...
                  Column(
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(labelText: 'Job Code'),
                      ),
                      SizedBox(height: 15,),
                                ...
                                child: ElevatedButton(
                                  onPressed: agreedToTerms
                                    ...
                                    _applyForJob();
                                      ...
                                      : null,
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: agreedToTerms ? Color(0xFFF13640) : null,
                                  ),
                                  child: Text(
                                    'Apply',
                                    textAlign: TextAlign.center,
  ...
  Future<void> _applyForJob() async {
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        saveJobProfile(widget.jobProfile);
  ...
  Future<void> ChangeStatustoApplied() async {
    final apiUrl = '${ApiUrls.baseurl}api/fresherjob';
